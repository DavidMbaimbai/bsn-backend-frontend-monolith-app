...
import com.davymbaimbai.bsn.entity.BookTransactionHistory;
import com.davymbaimbai.bsn.entity.User;
import com.davymbaimbai.bsn.exception.OperationNotPermittedException;
import com.davymbaimbai.bsn.mapper.BookMapper;
import com.davymbaimbai.bsn.repository.BookRepository;
import com.davymbaimbai.bsn.repository.BookTransactionHistoryRepository;
import com.davymbaimbai.bsn.specifications.BookSpecification;
...
public class BookService {
    ...
    public Integer borrowBook(Integer bookId, Authentication connectedUser) {
        ...
        if (book.isArchived() || !book.isShareable()) {
            throw new OperationNotPermittedException("The requested book can be borrowed since its archived or not shareable");
        }
        User user = (User) connectedUser.getPrincipal();
        if (Objects.equals(book.getOwner().getId(), user.getId())) {
            throw new OperationNotPermittedException("You can not borrow  your own book");
        }
        final boolean isAlreadyBorrowed = transactionHistoryRepository.isAlreadyBorrowedUser(bookId, user.getId());
    ...
    public Integer approveReturnBorrowedBook(Integer bookId, Authentication connectedUser) {
        ...
        BookTransactionHistory transactionHistory = transactionHistoryRepository.findByBookIdAndOwnerId(bookId,user.getId())
                .orElseThrow(()-> new OperationNotPermittedException("The book is not yet returned. You can cannot approve it."));
